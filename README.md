Overview
========
This project includes multiple linear regression (MLR), logistic regression (LogR) and enhanced annual temperature cycle (EATC) for river water temperature reconstruction. The codes are in the Code branch.
